...
[![R-CMD-check](https://github.com/moj-analytical-services/mojspeakr/actions/workflows/check-release.yaml/badge.svg)](https://github.com/moj-analytical-services/mojspeakr/actions/workflows/check-release.yaml)
<!-- badges: end -->
