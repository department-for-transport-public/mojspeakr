...
#' @param publication_type string describing type of RMarkdown output you would like the object to appear in. Options include "html" for html_document, "docx" for word_document, and "latex" for pdf_document.
...
conditional_publishing_output <- function(publication_type, output){
  if (knitr::opts_knit$get("rmarkdown.pandoc.to") == publication_type){output}
}
